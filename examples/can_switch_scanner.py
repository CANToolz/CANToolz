# Load needed modules
load_modules = {
    'hw_USBtin':    {'port':'auto', 'debug':1, 'speed':500},                # IO hardware module connected to first BUS (IVI)
    'hw_USBtin~2':  {'port':'auto', 'debug':1, 'speed':500, 'bus': 62 },    # IO hardware module (connected to OBD2)
