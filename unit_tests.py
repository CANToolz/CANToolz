...
class ModPingTests(unittest.TestCase):
    ...
    def test_isoanal(self):
        ...
        self.CANEngine.editModule("gen_ping",{'pipe':2,'range':[542999,543002],'body':'000000000000010203040506070102030405060711121314151617a1a2a3a4a5a6a7112233','mode':'isotp'})
        self.CANEngine.editModule("gen_ping~1",{'pipe':1,'range':[543002,543005],'body':'000000000000010203040506070102030405060711121314151617a1a2a3a4a5a6a7112233'})
    ...
    def test_emptyConfig(self):
        ...
        self.CANEngine.loadConfig("tests/test_2.conf")
        self.CANEngine.startLoop()
        self.CANEngine.editModule("gen_ping",{'pipe':2,'body':'000000000000010203040506070102030405060711121314151617a1a2a3a4a5a6a7112233','mode':'isotp'})
        self.CANEngine.callModule("gen_ping","s")
        time.sleep(1)
        ret = self.CANEngine.callModule("mod_stat","p")
        time.sleep(1)
    ...
    def test_ping(self):
        ...
        self.CANEngine.loadConfig("tests/test_2.conf")
        self.CANEngine.startLoop()
        self.CANEngine.editModule("gen_ping",{'pipe':2,'body':'000000000000010203040506070102030405060711121314151617a1a2a3a4a5a6a7112233','range':[542999,543002],'mode':'isotp'})
        self.CANEngine.callModule("gen_ping","s")
        time.sleep(1)
        ret = self.CANEngine.callModule("mod_stat","p")
        time.sleep(1)
        ...
        self.assertTrue( "25112233" == _bodyList[543001].keys()[5][1].encode('hex') , "Last packet of sec should be like that")
        self.assertTrue( "24a1a2a3a4a5a6a7" == _bodyList[543001].keys()[4][1].encode('hex') , "Last packet of sec should be like that")
...
class ModStatTests(unittest.TestCase):
    ...
    def test_blockedID(self):
        ...
        time.sleep(1)
        str=self.CANEngine.callModule("mod_stat","p")
        time.sleep(1)
        print str
        _bodyList = self.CANEngine._enabledList[index][1]._bodyList
